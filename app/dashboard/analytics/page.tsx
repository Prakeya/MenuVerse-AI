  ...
  return (
    <div>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 24, fontWeight: 800, color: '#1a1a1a', margin: 0 }}>Analytics</h1>
        <p style={{ fontSize: 14, color: '#6b7280', margin: '4px 0 0' }}>Live menu performance and diner behaviour.</p>
      </div>
      ...
      <div style={{ background: 'white', border: '1px solid #e5e7eb', borderRadius: 20, padding: 24 }}>
        <div style={{ fontSize: 14, fontWeight: 600, color: '#1a1a1a', marginBottom: 16 }}>Most Popular Dishes — Views</div>
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 16, height: 200, paddingTop: 24 }}>
          {[
            ...
            <div key={d.name} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ fontSize: 11, color: '#6b7280', marginTop: 8, textAlign: 'center' }}>{d.name}</div>
